...
private:
  static LLVM::LLVMFunctionType getPrintfType(MLIRContext *context) {
    ...
    constexpr bool enableVariadicArgs{true};
    auto llvmFnType = LLVM::LLVMFunctionType::get(llvmI32Type, llvmI8PtrTy,
                                                  enableVariadicArgs);
    return llvmFnType;
  }
  ...
  static FlatSymbolRefAttr getOrInsertPrintf(PatternRewriter &rewriter,
    ...
    auto printfFnType = getPrintfType(context);
    rewriter.create<LLVM::LLVMFuncOp>(module->getLoc(), "printf", printfFnType);
    return SymbolRefAttr::get(context, "printf");
  }
